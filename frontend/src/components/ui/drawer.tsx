...
/**
 * A side-anchored panel. Built on the same Base UI dialog primitive as
 * `Dialog`, so it inherits the focus trap, escape dismissal, and scroll lock
 * rather than reimplementing them — the only difference is where it sits and
...
const sideClass = {
  right: 'inset-y-0 right-0 border-l data-[ending-style]:translate-x-full data-[starting-style]:translate-x-full',
