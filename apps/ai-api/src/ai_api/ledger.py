...
def build_ledger_row(
    *,
    ...
    return {
        ...
        "supplier_country_code": (extracted.supplier_country_code if extracted else "") or "",
        "supplier_vat_number": (extracted.supplier_vat_number if extracted else "") or "",
        "buyer_name": buyer_name,
        "buyer_country_code": (extracted.buyer_country_code if extracted else "") or "",
        "buyer_vat_number": (extracted.buyer_vat_number if extracted else "") or "",
        ...
        "level_1": categorized.level_1 if categorized else "",
        "level_2": categorized.level_2 if categorized else "",
        "level_3": categorized.level_3 if categorized else "",
