...
>(({ className, ...props }, ref) => (
  <BaseField.Label ref={ref} className={cn('text-sm font-medium text-foreground', className)} {...props} />
))
...
>(({ className, ...props }, ref) => (
  <BaseField.Control ref={ref} className={cn(inputClassName, className)} {...props} />
))
...
>(({ className, ...props }, ref) => (
  <BaseField.Description ref={ref} className={cn('text-sm text-muted-foreground', className)} {...props} />
))
...
>(({ className, ...props }, ref) => (
  <BaseField.Error ref={ref} className={cn('text-sm text-destructive', className)} {...props} />
))
