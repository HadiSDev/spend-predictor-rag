"""Buyer profiles. The buyer's business decides Direct vs Indirect (level_1)."""
...
def level_1_for(profile: BuyerProfile, level_2: str) -> str:
    """Direct if the account's level_2 group is core to this buyer, else Indirect."""
    return "Direct" if level_2 in profile.direct_level_2 else "Indirect"
...
PROFILES: list[BuyerProfile] = [
    ...
    BuyerProfile(
        ...
        direct_level_2=frozenset({"Logistics", "People"}),
    ),
]
